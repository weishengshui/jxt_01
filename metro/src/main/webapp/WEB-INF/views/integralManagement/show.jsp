...
<body>
	...
	<form action="create" method="post" id="fm" enctype="multipart/form-data"> 
		<table border="0" style="font-size: 14px;">
			<tr>
				<td>
					<fieldset style="font-size: 14px;width:300px;height:auto;">
							...
							<table border="0">
								<tr>
									...
									<td width="200px" align="left">
										...
										<input id="displayName" name="displayName" value="${unit.displayName }" type="text" style="width:150px" class="easyui-validatebox" data-options="required:true" maxlength="20"/> 
									</td>
									<td></td>
								</tr>
								<tr>
									...
									<td width="200px" align="left">
										<input id="available" name="available" value="${unit.available }" type="text" style="width:150px" class="easyui-numberbox" data-options="precision:0,required:true" maxlength="5">&nbsp;&nbsp;月 
									</td>
									<td></td>
								</tr>
								<tr>
									...
									<td width="200px" align="left">
										<input id="price" name="price" value="${unit.price }" type="text" style="width:150px" class="easyui-numberbox" data-options="precision:2,required:true" maxlength="10">&nbsp;&nbsp;元 
									</td>
								</tr>
								<tr>
