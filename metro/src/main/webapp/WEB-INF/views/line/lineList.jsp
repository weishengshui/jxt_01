...
<script>
	...
	function edit(id_,name_){
		...
		parent.addTab('修改线路'+name,"line/lineUpdatePage?id="+id);
	}
	function del(id){
				...
				$.ajax({
		        	...
		        	success:function(data){
		        		if(data == 0){
		        			...
		        			$.messager.alert('提示','线路已与站台关联,不能被删除','warning');
		        		}
		        	}
				});
			}		
...
<body>
	...
	<!-- 显示列表Table -->
	<table id="table" class="easyui-datagrid" data-options="url:'findLines',fitColumns:true,striped:true,loadMsg:'正在载入...',pagination:true,toolbar: '#toolbar',
