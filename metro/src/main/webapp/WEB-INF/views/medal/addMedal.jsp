...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#saveMedal').click(function(){
			...
			var file1 = $('#image1').attr('src');
			var file2 = $('#image2').attr('src');
			if(file2 == ''){
				$.messager.alert('提示',"请上传勋章网站图片！");
				return false ;
			}
			if(file1 == ''){
				$.messager.alert('提示',"请上传勋章手机图片！");
				return false ;
			}
			...
			<div >
				...
				<form id="medalForm" method="post">
					...
					<input type="hidden" name="goasin" value="<%=token %>"/>
						...
						<tr>
							...
							<td><input id="obtainWay" name="obtainWay" type="text" data-options="required:true"
								style="width: 211px;" class="easyui-validatebox" maxlength="200"/>
							</td>
						</tr>
						<tr style="height: 10px;"></tr>
						<tr>
							...
							<td><textarea id="obtainCondition"
									...
									name="obtainCondition" rows="3" cols="24"></textarea>
							</td>
						</tr>
						<tr style="height: 10px;"></tr>
						<tr>
						...
						<tr>
							...
							<td><input id="revealSort" name="revealSort" type="text" class="easyui-numberbox"
									data-options="required:true" 
								style="width: 211px;" maxlength="9"/>
							</td>
						</tr>
					</table>
					</form>
				...
				<div id="main" style="margin-top: 10px;">
			    	...
			    	<div id="divPreview1" >
						...
						<a href="javascript:void(0)" onclick="deleteImage('key','divPreview1', 'image1')" iconCls="icon-remove" class="easyui-linkbutton" >删除</a>
					</div>
				    <div id="divDialog">
				...
				<div id="t3">
			    	...
			    	<div id="divPreview2" >
						...
						<a href="javascript:void(0)" onclick="deleteImage('key','divPreview2', 'image2')" iconCls="icon-remove" class="easyui-linkbutton" >删除</a>
					</div>
				    <div id="divDialog">
				    	<iframe scrolling="auto" id='openIframe' name="openIframe" frameborder="0"  src="" style="width:100%;height:100%;overflow: hidden;"></iframe> 
					</div>
				...
				<div align="left">
					<a id="saveMedal" href="javascript:void(0)" data-options="iconCls:'icon-save'" onclick=""
						class="easyui-linkbutton">保存</a> <a style="margin-left: 20px;"
						href="javascript:void(0)" data-options="iconCls:'icon-redo'" onclick="$('#medalForm').form('clear');$('#fm1').form('clear');$('#fm2').form('clear');deleteImage('key','divPreview1', 'image1');deleteImage('key','divPreview2', 'image2'); "
