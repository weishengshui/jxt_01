...
<body style="padding:20px;">
	...
	<fieldset>
		<legend>积分账户</legend>
		<table class="showTable" style="font-size: 14px;">
			<tr>
				<td>有效积分：</td>
				<td>${avalableJiFen }</td>
				<td>冻结积分：</td>
	...
	<fieldset>
		...
		<table id="dg" class="easyui-datagrid" data-options="url:'soonExpire',fitColumns:true,striped:true,loadMsg:'正在载入...',queryParams:{
				id: ${id }
			},
