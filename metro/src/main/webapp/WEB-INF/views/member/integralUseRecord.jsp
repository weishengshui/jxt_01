...
<body style="padding:20px;">
	...
	<fieldset>
		...
		<table id="table" class="easyui-datagrid" data-options="url:'integralUseRecord',fitColumns:true,striped:true,loadMsg:'正在载入...',pagination:true,
			...
			<thead>  
		        <tr>  
		            ...
		            <th data-options="field:'e',width:40,formatter:function(v,r,i){var tx = r.tx;if(tx){return dateFormat(tx.transactionDate);}}">交易时间</th>
