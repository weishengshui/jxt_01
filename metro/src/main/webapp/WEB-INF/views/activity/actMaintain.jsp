	...
	<div id="tabAct" class="easyui-tabs" style="width:650px;height: 550px;">
        <div title="活动信息新增" style="padding:10px">  
				...
				<legend style="color: blue;">优惠信息</legend>
					<table style="width: 600px;" >
						<tr>
							...
							<td><input id="title" class="easyui-validatebox" data-options="required:true" name="title" type="text" style="width: 211px;"/></td>
							<td>Pos机存根显示权益：</td>
						</tr>
						<tr>
							<td>&nbsp;&nbsp;&nbsp;描述：</td>
							<td><textarea id="descr"  name="descr" rows="3" cols="24"></textarea></td>
							<td><textarea id="posDescr"  name="posDescr" rows="3" cols="24"></textarea></td>
						</tr>
					</table>
				</fieldset>
				<br><br>
				<div align="center">
					<a id="saveActivity" href="javascript:void(0)" onclick="" data-options="iconCls:'icon-save'" class="easyui-linkbutton" >保存</a>
					<a style="margin-left: 20px;" href="javascript:void(0)" data-options="iconCls:'icon-redo'" onclick="$('#activityForm').form('clear');" class="easyui-linkbutton" >重置</a>
				</div>
	    	...
	    	<div id="divPreview" >
				...
				<a href="javascript:void(0)" onclick="deleteImage('key','divPreview')" iconCls="icon-remove" class="easyui-linkbutton" >删除</a>
			</div>
		    <div id="divDialog">
        ...
        <div title="参与品牌" style="padding:10px">  
			...
			<!-- 显示列表Table -->
			<table style="height:380px" id="table1"  title="" style="" class="easyui-datagrid" data-options="fitColumns:true,striped:true,loadMsg:'正在载入...',pagination:true,
			...
			<br>
			<div id="toolbar_1">
				<a id="addAct" href="javascript:void(0)" onclick="" iconCls="icon-add" class="easyui-linkbutton" >新增</a>
        ...
        <div title="POS机维护" style="padding:10px">  
			...
			<!-- 显示列表Table -->
			<table style="height:430px" id="table3"  title="" style="" class="easyui-datagrid" data-options="fitColumns:true,striped:true,loadMsg:'正在载入...',pagination:true,
			...
			<br>
			<div id="toolbar_2">
				<a id="addPos" href="javascript:void(0)" onclick="" iconCls="icon-add" class="easyui-linkbutton" >新增</a>
