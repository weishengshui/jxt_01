package com.chinarewards.metro.crypto;
...
public class DES3 {
	...
	final static Logger logger = LoggerFactory.getLogger(DES3.class);
	...
	public synchronized static String encryptStrMode(byte[] keybyte, String src)
		...
		try {
			...
			logger.trace("after encryptStrMode is " + Arrays.toString(ret));
