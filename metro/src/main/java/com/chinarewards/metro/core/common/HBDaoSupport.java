...
public class HBDaoSupport extends HibernateDaoSupport implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6652804966317537480L;
		...
		return getHibernateTemplate().executeWithNativeSession(
				new HibernateCallback<List<T>>() {
					public List<T> doInHibernate(Session session)
						...
						setQueryParameters(queryTotal, map);
						if (null != page) {
	 ...
	 * @return
	 */
	public <T> T findTs(final String hql, final Map<String, Object> params) {
		return getHibernateTemplate().executeWithNativeSession(
				new HibernateCallback<T>() {
					public T doInHibernate(Session session)
							throws HibernateException, SQLException {
