...
public interface IIntegralManagementService {
	...
	Unit findUnitByUnitCode(String unitCode);
	...
	/**
	 * External interface use the integral
	 * @param req
	 */
	IntegralConsumeResp useIntegral(IntegralConsumeReq req,IntegralConsumeResp resp);

	
	/**
	 * External interface add the integral
	 * @param req
	 * @return
	 */
	IntegralAddResp addIntegral(IntegralAddReq req);
}
