...
public interface IMerchandiseService {
	 ...
	 * @return
	 */
	List<MerchandiseVo> searchMerchandises(
	 ...
	 * @param categoryVos
	 *            商品类别信息
	 * @param merchandiseShopVos
	 * @param keywords
	 */
	void createMerchandise(Merchandise merchandise,
			List<SaleFormVo> saleFormVos, List<CategoryVo> categoryVos,
	 ...
	 * @return
	 */
	Map<String, FileItem> findMerchandiseFilesByMerchandise(
	 ...
	 * @return
	 */
	List<MerchandiseShopVo> getMerchandiseShopVosByMerchandise(
			Merchandise merchandise);
	 ...
	 * @return
	 */
	Integer countMerchandiseCategorys(String merchandiseCatalogId);

	/**
	 * 获取商品给webservice-client
	 * @param page 
	 * 
	 * @param request
	 * 
	 * @return
	 */
	List<com.chinarewards.metro.models.merchandise.Merchandise> getMerchandiseForClient(
			MerchandiseReq req, HttpServletRequest request);
	 ...
	 * @return
	 */
	List<MerchandiseKeyVo> getKeywordsByMerchandise(Merchandise merchandise);
	 ...
	 * @param images
	 */
	void saveImages(String id, Map<String, FileItem> images) throws IOException;
	 ...
	 * @return
	 */
	List<RedemptionDetail> getDetails(Integer orderInfoId);
}
