...
<script type="text/javascript">
		...
		function refreshImage(){
			$('#oldPic').attr('src', baseURL+'/view/showImage.do?id='+$('#id').val()+'&temp='+new Date().getTime());
		}
...
<body>
   	<s:form action="updateImage" namespace="/view" method="post" id="fm" enctype="multipart/form-data"> 
