...
%>
		...
		<div class="main2" id="orderchild" style="min-height: 497px;">
		  
			<div class="jfqcaxun">
				<span class="jfcaxun-t">福利券购买记录</span>
			...
			<div class="order" id="wolist">
				...
				<ul class="orderin">
					...
					if (isGly) {
						...
						strsql="select count(*) as hn from tbl_jfqdd where ddtype>0 and ((ddtype=1 and bmxz in ("+ffbm+")) or (ddtype=2 and bmxz in ("+ffxz+")) or (ddtype=3 and xdr="+session.getAttribute("ygid")+"))";
					}
					...
					if (isGly) {
						...
						strsql="select nid,ddsj,ddbh,ddsl,ddjf,zt from tbl_jfqdd where ddtype>0 and ((ddtype=1 and bmxz in ("+ffbm+")) or (ddtype=2 and bmxz in ("+ffxz+")) or (ddtype=3 and xdr="+session.getAttribute("ygid")+"))";
					}
					...
					while (rs.next())
						...
						<li>
							...
							<div class="orderin2"><a href="bworder.jsp?ddid=<%=rs.getString("nid")%>" target="_blank"><%=rs.getString("ddbh")%></a></div>
			...
			<div class="order-bottom">您还可以查看 <a href="buywelfare.jsp" target="_blank">未发放福利券</a> 或者去 <a href="buywelfare.jsp"   target="_blank">购买福利</a></div>
