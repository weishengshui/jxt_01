...
if (!fun.sqlStrCheck(ydh) || !fun.sqlStrCheck(ddh) || !fun.sqlStrCheck(pno) || !fun.sqlStrCheck(scjrq) || !fun.sqlStrCheck(naction) || !fun.sqlStrCheck(ecjrq) || !fun.sqlStrCheck(sfhrq) || !fun.sqlStrCheck(efhrq) )
{	
	response.sendRedirect("spwshd.jsp");
	return;
}
%>
...
try{
	...
	{
		strsql="update tbl_ygddzb set state=3,qsrq=now() where nid="+did+" and state=2";
		stmt.executeUpdate(strsql);
		
		strsql="update tbl_ygddmx set state=3 where dd="+did+" and state=2";
		stmt.executeUpdate(strsql);
	}
%>
    ...
    <td bgcolor="#f4f4f4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div class="local"><span>订单管理&gt; 未收货单</span></div></td>
          </tr>
          <tr>
            <td>
					<div class="caxunbox">
          ...
          <tr>
            ...
            <%
            	...
            	strsql="select count(nid) as hn from tbl_ygddzb where state=2";
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="1" cellpadding="1" class="maintable">
                  <tr>                   
                   ...
                   <th width="15%">订单付款日期</th>
                   <th width="15%">订单发货日期</th>
                   <th width="10%">订单号</th>
                   <th width="10%">使用积分</th>
                   <th width="10%">使用金额</th>
                  ...
                  <%
                  strsql="select nid, cjrq,ddh,zjf,zje,jfqsl,jsrq,fhrq,ydh from tbl_ygddzb where state=2";
                  if (ydh!=null && ydh.length()>0)
             			strsql+=" and ydh like '%"+ydh+"%'";
                  ...
                  <tr>
                    ...
                    <td><a href="#" onclick="changes(<%=rs.getString("nid")%>)" class="blue">签收</a></td>
                  </tr>
                 <%}
                  rs.close();
                  %>
